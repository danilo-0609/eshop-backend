...
namespace Catalog.Infrastructure.Migrations
{
    ...
    [Migration("20240212205842_Adding_Color_And_Size_Tables")]
    partial class AddingColorAndSizeTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Catalog.Domain.Products.Product", b =>
                {
                    ...
                    b.OwnsMany("Catalog.Domain.Products.ValueObjects.Color", "Colors", b1 =>
                        {
                            b1.Property<Guid>("ProductId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsMany("Catalog.Domain.Products.ValueObjects.Size", "Sizes", b1 =>
                        {
                            b1.Property<Guid>("ProductId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.ToTable("Sizes", "catalog");

                            b1.WithOwner()
                                .HasForeignKey("ProductId");
                        });

                    b.OwnsOne("Catalog.Domain.Products.ValueObjects.StockStatus", "StockStatus", b1 =>
                        {
                            b1.Property<Guid>("ProductId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsMany("Catalog.Domain.Products.ValueObjects.Tag", "Tags", b1 =>
                        {
                            b1.Property<Guid>("ProductId")
                                .HasColumnType("uniqueidentifier");
